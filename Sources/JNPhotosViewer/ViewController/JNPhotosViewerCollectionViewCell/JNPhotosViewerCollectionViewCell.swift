...
open class JNPhotosViewerCollectionViewCell: UICollectionViewCell , UIScrollViewDelegate {
    ...
    open class func registerCell(collectionView:UICollectionView) {
        collectionView.register(UINib(nibName: "JNPhotosViewerCollectionViewCell", bundle: Bundle.module), forCellWithReuseIdentifier: JNPhotosViewerCollectionViewCell.getReuseIdentifier())
    }
}
